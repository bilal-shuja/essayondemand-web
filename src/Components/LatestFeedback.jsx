  ...
  <div className="container">
    <div className="section-title">
      {/* {
       ...
       <h2 className="text-center feedback-heading" style={{color:colorScheme.black}}> Customers are talking about our writing service</h2>
       <p className="feedback-heading-para" style={{color:colorScheme.black}}>Check out the latest feedback from learners who use our essay writing services. </p>
