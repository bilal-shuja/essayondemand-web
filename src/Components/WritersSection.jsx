                    ...
                    return( */}
                        ...
                        <div className="card p-3" style={{background:"#FFFFFF",boxShadow:"0px 6px 8px rgba(199, 217, 237, 0.8)",border:"1px solid #7367F0", borderRadius:"20px"}}>
                            <div className="card-body">
                                ...
                                <img className="img-fluid p-1" src={avatar} alt="" style={{width:"5em",borderRadius:"4px",boxShadow:"0px 4px 4px #7367F0",border:"1px solid #7367F0"}} />
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <p className="mt-1"style={{fontSize:"18px",fontFamily:"Montserrat",fontWeight:"500",letterSpacing:"0.05em",color:"#0E101A"}}>Alexa peter</p>
                                    ...
                                    <p  style={{fontSize:"21px",fontWeight:"600",color:"#7367F0",marginLeft:"-1em",marginTop:"-0.2em"}}>4.6 &nbsp;</p>
                                    &nbsp;
                                    {/* <DynamicStar className="img-fluid " rating={"items.rating"} alt="" width={22} /> */}
                                    <DynamicStar className="img-fluid " rating={4.6} alt="" width={22} />

                                    </div>
                                    {/* <p className="text-center"style={{color:"#A49BFF", marginTop:"-3em"}}>({"items.num_of_reviews"} reviews)</p> */}
                                    <p className="text-center"style={{color:"#A49BFF", marginTop:"-3em"}}>(14567 reviews)</p>
                                ...
                                <div className="d-flex justify-content-between mt-3">
                                        ...
                                        <p className="align-items-center"style={{fontSize:"24px",fontWeight:"600",color:"#7367F0"}}>15667</p>
                                </div>
            
                                <div className="d-flex gap-4 mt-4">
                                <Link to="/AboutWriter"  
                                // state={{id:items.id}}
                                className="btn btn-outline-primary about-writer ms-3" 
                                style={{borderRadius:"3px", width:"117px",border:"1px solid #367FD3"}}> About Writer</Link>
