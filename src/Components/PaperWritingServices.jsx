  ...
  return (
    ...
    <section id="doctors" className="doctors">
      ...
      <p className="text-center feedback-heading-para" style={{color:colorScheme.black}}>{items.subtitle_5}</p>
         ...
         <h1 className="text-center feedback-heading" >Your #1 paper writing service</h1>
         <p className="text-center feedback-heading-para" style={{color:colorScheme.black}}>Our expert essay writers can tackle any academic task you entrust them with. Here are some of the services we offer.</p>
